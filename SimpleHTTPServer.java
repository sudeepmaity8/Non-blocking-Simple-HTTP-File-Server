/*
 * This program demonstrates a single nonblocking File Server
 * */
...
public class SimpleHTTPServer 
{
	...
	private int port = 80;
	public SimpleHTTPServer(ByteBuffer data, String encoding, String MIMEType, int port) 
	{
		this.port = port;
	...
	public static void main(String args[]) 
	{
			...
			try 
			{
				...
				catch (RuntimeException ex) 
				{
					...
					SimpleHTTPServer server= new SimpleHTTPServer(input, encoding, contentType, port);
					server.run();
				} 
			  catch (IOException ex) 
			  {
